...
class RakJenisController extends \yii\web\Controller
{
    ...
    public function actionListData()
    {
        ...
        $query = \app\models\RakJenis::find()->where(array("jaringan_id" => $user->jaringan_id, "status" => "1"));
    ...
    public function actionSave($id = NULL)
    {
        if ($id == null) {
            ...
            $model = \app\models\RakJenis::find()->where(array("id" => $id))->one();
            if ($model->load($_POST)) {
                if ($model->save()) {
                    return \yii\helpers\Json::encode(array("status" => "OK", "message" => "Simpan Data Berhasil"));
                }
