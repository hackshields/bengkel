...
class LaporanKaryawanController extends \yii\web\Controller
{
    ...
    public function actionLaporanKaryawan()
    {
        ...
        }, "header" => $this->getHeaderNota("LAPORAN DATA ABSENSI KARYAWAN")));
        return $this->renderPartial("laporan-karyawan", array());
    }
