...
class PengeluaranPartTipe extends \yii\db\ActiveRecord
{
    public static function tableName()
    {
        return "pengeluaran_part_tipe";
    }
    ...
    {
        return $this->hasMany(\app\models\PengeluaranPart::className(), array("pengeluaran_part_tipe_id" => "id"));
    }
