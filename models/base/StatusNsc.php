...
class StatusNsc extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(\app\models\PengeluaranPart::className(), array("status_nsc_id" => "id"));
    }
    public function getPerintahKerjas()
    {
        return $this->hasMany(\app\models\PerintahKerja::className(), array("status_nsc_id" => "id"));
    }
