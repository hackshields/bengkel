...
$totalSukuCadang = 0;
foreach ($notaSukuCadang->pengeluaranPartDetails as $nscPart) {
    echo "        <tr>\n            <td>";
    echo $nscPart->sukuCadang->nama;
    echo "</td>\n            <td style=\"text-align: center\">";
    echo app\components\Angka::toReadableAngka($nscPart->quantity);
    echo "</td>\n            <td style=\"text-align: right\">";
    echo app\components\Angka::toReadableAngka($nscPart->het);
    echo "</td>\n            <td style=\"text-align: center\">\n                ";
    if ($nscPart->diskon_p != 0) {
        echo $nscPart->diskon_p . " %";
    } else {
        echo $nscPart->diskon_r;
    }
    echo "            </td>\n            <td style=\"text-align: right\">";
    echo app\components\Angka::toReadableAngka($nscPart->total);
    echo "</td>\n        </tr>\n        ";
    $totalSukuCadang += $nscPart->total;
}
echo "</table>\n<hr>\nCatatan :\n";
echo $model->catatan;
echo "<hr>\n\n";
...
echo strtoupper(app\components\Angka::toTerbilang($totalSukuCadang));
echo " RUPIAH #\n</div>\n<hr/>\n<div style=\"font-size: 10\">\n    # GARANSI SERVICE : 500 KM ATAU 7 HARI MANA YANG TERCAPAI LEBIH DAHULU #\n    <hr/>\n    <div style=\"text-align: right\">\n        # CETAKAN KE-";
echo $notaSukuCadang->nomor_cetak;
echo "  ";
echo date("d/m/Y H:i:s");
echo " #\n    </div>\n</body>\n</html>\n";
$notaSukuCadang->nomor_cetak += 1;
$notaSukuCadang->save();
