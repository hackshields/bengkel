...
class Tanggal
{
    ...
    {
        $jml = array("01" => 31, "02" => 28, "03" => 31, "04" => 30, "05" => 31, "06" => 30, "07" => 31, "08" => 31, "09" => 30, 10 => 31, 11 => 30, 12 => 31);
    ...
    public static function timeElapsedString($ptime)
    {
        ...
        $a = array(365 * 24 * 60 * 60 => "tahun", 30 * 24 * 60 * 60 => "bulan", 24 * 60 * 60 => "hari", 60 * 60 => "jam", 60 => "menit", 1 => "detik");
        $a_plural = array("tahun" => "tahun", "bulan" => "bulan", "hari" => "hari", "jam" => "jam", "menit" => "menit", "detik" => "detik");
        foreach ($a as $secs => $str) {
            $d = $etime / $secs;
            if (1 <= $d) {
                $r = round($d);
                return $r . " " . (1 < $r ? $a_plural[$str] : $str) . " yang lalu";
            }
        }
    }
    ...
    {
        $hari = 31 < $hari ? 0 : $hari;
        $bulan = 12 < $hari ? 0 : $bulan;
        $tahun = 200 < $hari ? 80 : $tahun;
