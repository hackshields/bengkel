...
class Icon
{
    ...
    {
        $this->_checkValue($value, [FA::SIZE_LARGE, FA::SIZE_2X, FA::SIZE_3X, FA::SIZE_4X, FA::SIZE_5X], 'FA::size() - invalid value. Use one of the constants: FA::SIZE_LARGE, FA::SIZE_2X, FA::SIZE_3X, FA::SIZE_4X, FA::SIZE_5X.');
    ...
    {
        $this->_checkValue($value, [FA::ROTATE_90, FA::ROTATE_180, FA::ROTATE_270], 'FA::rotate() - invalid value. Use one of the constants: FA::ROTATE_90, FA::ROTATE_180, FA::ROTATE_270.');
    ...
    {
        $this->_checkValue($value, [FA::FLIP_HORIZONTAL, FA::FLIP_VERTICAL], 'FA::flip() - invalid value. Use one of the constants: FA::FLIP_HORIZONTAL, FA::FLIP_VERTICAL.');
