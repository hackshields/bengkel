...
if (Yii::$app->user->identity->isAdmin) {
    ...
    ?>
                ...
                <a href="<?php 
    echo \yii\helpers\Url::to('http://phundament.com');
...
foreach (\Yii::$app->urlManager->languages as $name) {
    echo yii\helpers\Html::a($name, ['', \Yii::$app->urlManager->languageParam => $name], ['class' => 'btn btn-default btn-flat ' . (Yii::$app->language == $name ? 'active' : '')]);
}
?>
            </div>
            <!-- /.box-body -->
