    ...
    private function _readXf()
    {
        ...
        if (!$this->_readDataOnly) {
            ...
            if ($this->_version == self::XLS_BIFF8) {
                ...
                $objStyle->getBorders()->getLeft()->colorIndex = (0x7f0000 & self::_GetInt4d($recordData, 10)) >> 16;
                ...
                $diagonalUp = (2147483648.0 & self::_GetInt4d($recordData, 10)) >> 31 ? true : false;
                ...
                $objStyle->getBorders()->getTop()->colorIndex = (0x7f & self::_GetInt4d($recordData, 14)) >> 0;
                // bit: 13-7; mask: 0x00003F80; bottom color
                $objStyle->getBorders()->getBottom()->colorIndex = (0x3f80 & self::_GetInt4d($recordData, 14)) >> 7;
                // bit: 20-14; mask: 0x001FC000; diagonal color
                $objStyle->getBorders()->getDiagonal()->colorIndex = (0x1fc000 & self::_GetInt4d($recordData, 14)) >> 14;
                // bit: 24-21; mask: 0x01E00000; diagonal style
                if ($bordersDiagonalStyle = self::_mapBorderStyle((0x1e00000 & self::_GetInt4d($recordData, 14)) >> 21)) {
                    $objStyle->getBorders()->getDiagonal()->setBorderStyle($bordersDiagonalStyle);
                }
                // bit: 31-26; mask: 0xFC000000 fill pattern
                if ($fillType = self::_mapFillPattern((4227858432.0 & self::_GetInt4d($recordData, 14)) >> 26)) {
                    $objStyle->getFill()->setFillType($fillType);
                }
                // offset: 18; size: 2; pattern and background colour
                // bit: 6-0; mask: 0x007F; color index for pattern color
                $objStyle->getFill()->startcolorIndex = (0x7f & self::_GetInt2d($recordData, 18)) >> 0;
                ...
                $objStyle->getFill()->setFillType(self::_mapFillPattern((0x3f0000 & $borderAndBackground) >> 16));
                // bit: 24-22; mask: 0x01C00000; bottom line style
                $objStyle->getBorders()->getBottom()->setBorderStyle(self::_mapBorderStyle((0x1c00000 & $borderAndBackground) >> 22));
                ...
                $objStyle->getBorders()->getTop()->setBorderStyle(self::_mapBorderStyle((0x7 & $borderLines) >> 0));
                // bit: 5-3; mask: 0x00000038; left line style
                $objStyle->getBorders()->getLeft()->setBorderStyle(self::_mapBorderStyle((0x38 & $borderLines) >> 3));
                // bit: 8-6; mask: 0x000001C0; right line style
                $objStyle->getBorders()->getRight()->setBorderStyle(self::_mapBorderStyle((0x1c0 & $borderLines) >> 6));
