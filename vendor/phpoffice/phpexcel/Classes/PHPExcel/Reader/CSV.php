...
class PHPExcel_Reader_CSV extends PHPExcel_Reader_Abstract implements PHPExcel_Reader_IReader
{
    ...
    protected function _skipBOM()
    {
        ...
        switch ($this->_inputEncoding) {
            case 'UTF-8':
                fgets($this->_fileHandle, 4) == "ï»¿" ? fseek($this->_fileHandle, 3) : fseek($this->_fileHandle, 0);
                break;
            case 'UTF-16LE':
                fgets($this->_fileHandle, 3) == "ÿþ" ? fseek($this->_fileHandle, 2) : fseek($this->_fileHandle, 0);
                break;
            case 'UTF-16BE':
                fgets($this->_fileHandle, 3) == "þÿ" ? fseek($this->_fileHandle, 2) : fseek($this->_fileHandle, 0);
                break;
            case 'UTF-32LE':
                fgets($this->_fileHandle, 5) == "ÿþ\0\0" ? fseek($this->_fileHandle, 4) : fseek($this->_fileHandle, 0);
                break;
            case 'UTF-32BE':
                fgets($this->_fileHandle, 5) == "\0\0þÿ" ? fseek($this->_fileHandle, 4) : fseek($this->_fileHandle, 0);
                break;
            default:
                break;
        }
