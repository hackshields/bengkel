...
class PHPExcel_Writer_Excel5 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    private function _writeDocumentSummaryInformation()
    {
        ...
        $dataSection[] = array(
            'summary' => array('pack' => 'V', 'data' => 0x1),
            'offset' => array('pack' => 'V'),
            'type' => array('pack' => 'V', 'data' => 0x2),
        ...
        $dataSection[] = array('summary' => array('pack' => 'V', 'data' => 0x17), 'offset' => array('pack' => 'V'), 'type' => array('pack' => 'V', 'data' => 0x3), 'data' => array('pack' => 'V', 'data' => 0xc0000));
        $dataSection_NumProps++;
        // GKPIDDSI_SCALE : FALSE
        $dataSection[] = array('summary' => array('pack' => 'V', 'data' => 0xb), 'offset' => array('pack' => 'V'), 'type' => array('pack' => 'V', 'data' => 0xb), 'data' => array('data' => false));
        $dataSection_NumProps++;
        // GKPIDDSI_LINKSDIRTY : True if any of the values for the linked properties have changed outside of the application
        $dataSection[] = array('summary' => array('pack' => 'V', 'data' => 0x10), 'offset' => array('pack' => 'V'), 'type' => array('pack' => 'V', 'data' => 0xb), 'data' => array('data' => false));
        $dataSection_NumProps++;
        // GKPIDDSI_SHAREDOC : FALSE
        $dataSection[] = array('summary' => array('pack' => 'V', 'data' => 0x13), 'offset' => array('pack' => 'V'), 'type' => array('pack' => 'V', 'data' => 0xb), 'data' => array('data' => false));
        $dataSection_NumProps++;
        ...
        $dataSection[] = array('summary' => array('pack' => 'V', 'data' => 0x16), 'offset' => array('pack' => 'V'), 'type' => array('pack' => 'V', 'data' => 0xb), 'data' => array('data' => false));
        $dataSection_NumProps++;
        // GKPIDDSI_DOCSPARTS
        ...
        $dataSection[] = array('summary' => array('pack' => 'V', 'data' => 0xd), 'offset' => array('pack' => 'V'), 'type' => array('pack' => 'V', 'data' => 0x101e), 'data' => array('data' => $dataProp, 'length' => strlen($dataProp)));
        $dataSection_NumProps++;
        ...
        $dataProp .= pack('v', 0x0);
        $dataProp .= pack('v', 0x0);
        $dataSection[] = array('summary' => array('pack' => 'V', 'data' => 0xc), 'offset' => array('pack' => 'V'), 'type' => array('pack' => 'V', 'data' => 0x100c), 'data' => array('data' => $dataProp, 'length' => strlen($dataProp)));
        $dataSection_NumProps++;
        // 		4 	Section Length
        //		4 	Property count
