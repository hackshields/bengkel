...
class PHPExcel_Chart_Axis extends PHPExcel_Properties
{
    ...
    {
        !is_null($line_width) ? $this->_line_style_properties['width'] = $this->getExcelPointsWidth((double) $line_width) : NULL;
