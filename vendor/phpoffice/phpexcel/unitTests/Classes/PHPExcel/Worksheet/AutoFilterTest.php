...
class AutoFilterTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->_mockCacheController = $this->getMockBuilder('PHPExcel_CachedObjectStorage_Memory')->disableOriginalConstructor()->getMock();
        $this->_mockWorksheetObject->expects($this->any())->method('getCellCacheController')->will($this->returnValue($this->_mockCacheController));
    ...
    {
        $ranges = array('G1:J512' => 'Worksheet1!G1:J512', 'K1:N20' => 'K1:N20');
    ...
    {
        $columnIndexes = array('H' => 0, 'K' => 3, 'M' => 5);
    ...
    {
        $columnIndexes = array(0 => 'H', 3 => 'K', 5 => 'M');
