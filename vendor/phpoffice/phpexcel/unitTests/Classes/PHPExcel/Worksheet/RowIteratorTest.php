...
class RowIteratorTest extends PHPUnit_Framework_TestCase
{
    ...
    public function setUp()
    {
        ...
        $this->mockRow = $this->getMockBuilder('PHPExcel_Worksheet_Row')->disableOriginalConstructor()->getMock();
        ...
        $this->mockWorksheet->expects($this->any())->method('current')->will($this->returnValue($this->mockRow));
    }
