...
class DateTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $calendarValues = array(PHPExcel_Shared_Date::CALENDAR_MAC_1904, PHPExcel_Shared_Date::CALENDAR_WINDOWS_1900);
    ...
    {
        $result = call_user_func(array('PHPExcel_Shared_Date', 'setExcelCalendar'), PHPExcel_Shared_Date::CALENDAR_WINDOWS_1900);
        $args = func_get_args();
    ...
    public function testDateTimePHPToExcel1900()
    {
        ...
        $this->assertEquals($expectedResult, $result, NULL, 1.0E-5);
    }
    ...
    {
        $result = call_user_func(array('PHPExcel_Shared_Date', 'setExcelCalendar'), PHPExcel_Shared_Date::CALENDAR_MAC_1904);
        $args = func_get_args();
        $expectedResult = array_pop($args);
        if ($args[0] < 1) {
            $expectedResult += gmmktime(0, 0, 0);
