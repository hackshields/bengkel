...
class LegendTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $positionValues = array(PHPExcel_Chart_Legend::POSITION_RIGHT, PHPExcel_Chart_Legend::POSITION_LEFT, PHPExcel_Chart_Legend::POSITION_TOP, PHPExcel_Chart_Legend::POSITION_BOTTOM, PHPExcel_Chart_Legend::POSITION_TOPRIGHT);
    ...
    {
        $positionValues = array(PHPExcel_Chart_Legend::xlLegendPositionBottom, PHPExcel_Chart_Legend::xlLegendPositionCorner, PHPExcel_Chart_Legend::xlLegendPositionCustom, PHPExcel_Chart_Legend::xlLegendPositionLeft, PHPExcel_Chart_Legend::xlLegendPositionRight, PHPExcel_Chart_Legend::xlLegendPositionTop);
        $testInstance = new PHPExcel_Chart_Legend();
        foreach ($positionValues as $positionValue) {
    ...
    {
        $overlayValues = array(TRUE, FALSE);
        $testInstance = new PHPExcel_Chart_Legend();
