...
class DateTimeTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testDATE()
    {
        ...
        $this->assertEquals($expectedResult, $result, NULL, 1.0E-8);
    }
    ...
    public function testDATEtoPHP()
    {
        ...
        $this->assertEquals(1327968000, $result, NULL, 1.0E-8);
    }
    ...
    public function testTIMEtoPHP()
    {
        ...
        PHPExcel_Calculation_Functions::setReturnDateType(PHPExcel_Calculation_Functions::RETURNDATE_EXCEL);
        $this->assertEquals(27020, $result, NULL, 1.0E-8);
    }
    ...
    public function testTIMEVALUEtoPHP()
    {
        ...
        PHPExcel_Calculation_Functions::setReturnDateType(PHPExcel_Calculation_Functions::RETURNDATE_EXCEL);
        $this->assertEquals(23420, $result, NULL, 1.0E-8);
    }
    ...
    public function testEDATEtoPHP()
    {
        ...
        PHPExcel_Calculation_Functions::setReturnDateType(PHPExcel_Calculation_Functions::RETURNDATE_EXCEL);
        $this->assertEquals(1324857600, $result, NULL, 1.0E-8);
    }
    ...
    public function testEOMONTHtoPHP()
    {
        ...
        PHPExcel_Calculation_Functions::setReturnDateType(PHPExcel_Calculation_Functions::RETURNDATE_EXCEL);
        $this->assertEquals(1325289600, $result, NULL, 1.0E-8);
    }
