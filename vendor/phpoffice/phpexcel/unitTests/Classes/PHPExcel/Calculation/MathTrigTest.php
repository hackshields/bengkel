...
class MathTrigTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        return array(array(array(array(1), array(5), array(10)), '>=5', 15), array(array(array('text'), array(2)), '=text', array(array(10), array(100)), 10), array(array(array('"text with quotes"'), array(2)), '="text with quotes"', array(array(10), array(100)), 10), array(
            array(array('"text with quotes"'), array('')),
            '>"',
            // Compare to the single characater " (double quote)
            array(array(10), array(100)),
            10,
        ), array(
            array(array(''), array('anything')),
            '>"',
            // Compare to the single characater " (double quote)
            array(array(10), array(100)),
            100,
