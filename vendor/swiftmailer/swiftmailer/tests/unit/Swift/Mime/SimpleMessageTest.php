...
class Swift_Mime_SimpleMessageTest extends Swift_Mime_MimePartTest
{
    ...
    public function testDateIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('Date' => $date)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testIdIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('Message-ID' => $messageId)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testSubjectIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('Subject' => $subject)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testReturnPathIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('Return-Path' => $path)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testSenderIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('Sender' => $sender)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testSenderIsSetInHeader()
    {
        ...
        $sender->shouldReceive('setFieldBodyModel')->once()->with(array('other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('Sender' => $sender)), $this->_createEncoder(), $this->_createCache());
    ...
    {
        $headers = $this->_createHeaderSet(array(), false);
        $headers->shouldReceive('addMailboxHeader')->once()->with('Sender', array('sender@domain' => 'Name'));
        $headers->shouldReceive('addMailboxHeader')->zeroOrMoreTimes();
        $message = $this->_createMessage($headers, $this->_createEncoder(), $this->_createCache());
    ...
    public function testFromIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('From' => $from)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testFromIsSetInHeader()
    {
        ...
        $from->shouldReceive('setFieldBodyModel')->once()->with(array('other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('From' => $from)), $this->_createEncoder(), $this->_createCache());
    ...
    {
        $from = $this->_createHeader('From', array('from@domain' => 'Name'), array(), false);
        $from->shouldReceive('setFieldBodyModel')->once()->with(array('from@domain' => 'Name', 'other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('From' => $from)), $this->_createEncoder(), $this->_createCache());
    ...
    {
        $headers = $this->_createHeaderSet(array(), false);
        $headers->shouldReceive('addMailboxHeader')->once()->with('From', array('from@domain' => 'Name'));
        $headers->shouldReceive('addMailboxHeader')->zeroOrMoreTimes();
        $message = $this->_createMessage($headers, $this->_createEncoder(), $this->_createCache());
    ...
    public function testReplyToIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('Reply-To' => $reply)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testReplyToIsSetInHeader()
    {
        ...
        $reply->shouldReceive('setFieldBodyModel')->once()->with(array('other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('Reply-To' => $reply)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testReplyToIsAddedToHeadersDuringAddReplyTo()
    {
        ...
        $replyTo->shouldReceive('setFieldBodyModel')->once()->with(array('from@domain' => 'Name', 'other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('Reply-To' => $replyTo)), $this->_createEncoder(), $this->_createCache());
    ...
    {
        $headers = $this->_createHeaderSet(array(), false);
        $headers->shouldReceive('addMailboxHeader')->once()->with('Reply-To', array('reply@domain' => 'Name'));
        $headers->shouldReceive('addMailboxHeader')->zeroOrMoreTimes();
        $message = $this->_createMessage($headers, $this->_createEncoder(), $this->_createCache());
    ...
    public function testToIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('To' => $to)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testToIsSetInHeader()
    {
        ...
        $to->shouldReceive('setFieldBodyModel')->once()->with(array('other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('To' => $to)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testToIsAddedToHeadersDuringAddTo()
    {
        ...
        $to->shouldReceive('setFieldBodyModel')->once()->with(array('from@domain' => 'Name', 'other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('To' => $to)), $this->_createEncoder(), $this->_createCache());
    ...
    {
        $headers = $this->_createHeaderSet(array(), false);
        $headers->shouldReceive('addMailboxHeader')->once()->with('To', array('to@domain' => 'Name'));
        $headers->shouldReceive('addMailboxHeader')->zeroOrMoreTimes();
        $message = $this->_createMessage($headers, $this->_createEncoder(), $this->_createCache());
    ...
    public function testCcIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('Cc' => $cc)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testCcIsSetInHeader()
    {
        ...
        $cc->shouldReceive('setFieldBodyModel')->once()->with(array('other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('Cc' => $cc)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testCcIsAddedToHeadersDuringAddCc()
    {
        ...
        $cc->shouldReceive('setFieldBodyModel')->once()->with(array('from@domain' => 'Name', 'other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('Cc' => $cc)), $this->_createEncoder(), $this->_createCache());
    ...
    {
        $headers = $this->_createHeaderSet(array(), false);
        $headers->shouldReceive('addMailboxHeader')->once()->with('Cc', array('cc@domain' => 'Name'));
        $headers->shouldReceive('addMailboxHeader')->zeroOrMoreTimes();
        $message = $this->_createMessage($headers, $this->_createEncoder(), $this->_createCache());
    ...
    public function testBccIsReturnedFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('Bcc' => $bcc)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testBccIsSetInHeader()
    {
        ...
        $bcc->shouldReceive('setFieldBodyModel')->once()->with(array('other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('Bcc' => $bcc)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testBccIsAddedToHeadersDuringAddBcc()
    {
        ...
        $bcc->shouldReceive('setFieldBodyModel')->once()->with(array('from@domain' => 'Name', 'other@domain' => 'Other'));
        $message = $this->_createMessage($this->_createHeaderSet(array('Bcc' => $bcc)), $this->_createEncoder(), $this->_createCache());
    ...
    {
        $headers = $this->_createHeaderSet(array(), false);
        $headers->shouldReceive('addMailboxHeader')->once()->with('Bcc', array('bcc@domain' => 'Name'));
        $headers->shouldReceive('addMailboxHeader')->zeroOrMoreTimes();
        $message = $this->_createMessage($headers, $this->_createEncoder(), $this->_createCache());
    ...
    public function testPriorityIsReadFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('X-Priority' => $prio)), $this->_createEncoder(), $this->_createCache());
    ...
    public function testReadReceiptAddressReadFromHeader()
    {
        ...
        $message = $this->_createMessage($this->_createHeaderSet(array('Disposition-Notification-To' => $rcpt)), $this->_createEncoder(), $this->_createCache());
