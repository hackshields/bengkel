...
abstract class Swift_Mime_AbstractMimeEntityTest extends \SwiftMailerTestCase
{
    ...
    public function testSettingEncoderUpdatesTransferEncoding()
    {
        ...
        $headers = $this->_createHeaderSet(array('Content-Transfer-Encoding' => $encoding));
    ...
    // -- Private helpers
    protected abstract function _createEntity($headers, $encoder, $cache);
