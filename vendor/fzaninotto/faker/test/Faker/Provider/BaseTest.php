...
class BaseTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testNumerifyCanGenerateALargeNumberOfDigits()
    {
        ...
        // definitely larger than PHP_INT_MAX on all systems
    ...
    {
        return array(array('azeQSDF1234', 'azeQSDF1234', 'does not change non regex chars'), array('foo(bar){1}', 'foobar', 'replaces regex characters'), array('', '', 'supports empty string'), array('/^foo(bar){1}$/', 'foobar', 'ignores regex delimiters'));
    }
    /**
