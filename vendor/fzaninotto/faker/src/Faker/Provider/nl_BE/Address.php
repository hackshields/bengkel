...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetSuffix = array('baan', 'boulevard', 'dreef', 'hof', 'laan', 'pad', 'ring', 'singel', 'steeg', 'straat', 'weg');
    /**
