...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetPrefix = array('Str.', 'B-dul.', 'Aleea', 'Calea', 'P-ța', 'Str-la');
    ...
    protected static $addressFormats = array("{{streetAddress}}, {{city}}, CP {{postcode}}");
