...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $province = array('Eastern Cape', 'Free State', 'Gauteng', 'KwaZulu-Natal', 'Limpopo', 'Mpumalanga', 'North-West', 'Northern Cape', 'Western Cape');
    protected static $provinceAbbr = array('EC', 'FS', 'GP', 'KZN', 'LP', 'MP', 'NW', 'NC', 'WC');
