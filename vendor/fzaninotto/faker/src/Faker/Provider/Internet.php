...
class Internet extends \Faker\Provider\Base
{
    ...
    {
        return long2ip(mt_rand(0, 1) == 0 ? mt_rand(-2147483648.0, 0) : mt_rand(1, 2147483647));
    }
    /**
    ...
    public static function localIpv4()
    {
        if (static::numberBetween(0, 1) === 0) {
            ...
            // 192.168.x.x range
            $ip = long2ip(static::numberBetween(3232235520.0, 3232301055.0));
        }
        return $ip;
    }
    /**
