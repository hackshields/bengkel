...
class Person extends \Faker\Provider\Base
{
    ...
    protected static $titleFormat = array('{{titleMale}}', '{{titleFemale}}');
    protected static $firstNameFormat = array('{{firstNameMale}}', '{{firstNameFemale}}');
    protected static $maleNameFormats = array('{{firstNameMale}} {{lastName}}');
    protected static $femaleNameFormats = array('{{firstNameFemale}} {{lastName}}');
    protected static $firstNameMale = array('John');
    protected static $firstNameFemale = array('Jane');
