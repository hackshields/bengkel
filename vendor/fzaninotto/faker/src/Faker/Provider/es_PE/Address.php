...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $state = array('Lima', 'Callao', 'Arequipa', 'Cuzco', 'Piura', 'Iquitos', 'Huaraz', 'Tacna', 'Ayacucho', 'Pucallpa', 'Trujillo', 'Chimbote', 'Ica', 'Moquegua', 'Puno', 'Tarapoto', 'Cajamarca', 'Lambayeque', 'Huanuco', 'Jauja', 'Tumbes', 'Madre de Dios');
    ...
    protected static $cityFormats = array('{{cityPrefix}} {{firstName}} {{lastName}}', '{{cityPrefix}} {{firstName}}', '{{firstName}} {{citySuffix}}', '{{lastName}} {{citySuffix}}');
    protected static $streetNameFormats = array('{{streetPrefix}} {{firstName}} {{lastName}}');
