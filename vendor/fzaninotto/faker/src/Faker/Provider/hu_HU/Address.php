...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $state = array('Budapest', 'Bács-Kiskun', 'Baranya', 'Békés', 'Borsod-Abaúj-Zemplén', 'Csongrád', 'Fejér', 'Győr-Moson-Sopron', 'Hajdú-Bihar', 'Heves', 'Jász-Nagykun-Szolnok', 'Komárom-Esztergom', 'Nógrád', 'Pest', 'Somogy', 'Szabolcs-Szatmár-Bereg', 'Tolna', 'Vas', 'Veszprém', 'Zala');
    ...
    protected static $cityFormats = array('{{firstName}}', '{{lastName}}');
    ...
    protected static $addressFormats = array("{{postcode}} {{city}}, {{streetAddress}}");
