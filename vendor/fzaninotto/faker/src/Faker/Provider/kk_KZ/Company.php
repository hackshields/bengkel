...
class Company extends \Faker\Provider\Company
{
    ...
    protected static $companyPrefixes = array('АҚ', 'ЖШС', 'ЖАҚ');
    protected static $companyNameSuffixes = array('Құрылыс', 'Машина', 'Бұзу', '-М', 'Лизинг', 'Страх', 'Ком', 'Телеком');
    protected static $companyElements = array('Қазақ', 'Кітап', 'Цемент', 'Лифт', 'Креп', 'Авто', 'Теле', 'Транс', 'Алмаз', 'Метиз', 'Мотор', 'Қаз', 'Тех', 'Сантех', 'Алматы', 'Астана', 'Электро');
    /**
