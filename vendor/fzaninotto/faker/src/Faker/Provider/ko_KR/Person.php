...
class Person extends \Faker\Provider\Person
{
     ...
     */
    protected static $lastName = array('강', '고', '곽', '권', '김', '남', '노', '류', '문', '박', '배', '백', '서', '손', '송', '신', '심', '안', '양', '오', '유', '윤', '이', '임', '장', '전', '정', '조', '최', '하', '한', '허', '홍', '황');
}
