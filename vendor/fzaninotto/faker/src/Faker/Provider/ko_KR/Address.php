...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $metropolitanCity = array('서울특별시', '부산광역시', '대구광역시', '인천광역시', '광주광역시', '대전광역시', '울산광역시');
    protected static $province = array('경기도', '강원도', '충청북도', '충청남도', '전라북도', '전라남도', '경상북도', '경상남도', '제주특별자치도');
    ...
    protected static $borough = array('종로구', '중구', '용산구', '성동구', '광진구', '동대문구', '중랑구', '성북구', '강북구', '도봉구', '노원구', '은평구', '서대문구', '마포구', '양천구', '강서구', '구로구', '금천구', '영등포구', '동작구', '관악구', '서초구', '강남구', '송파구', '강동구', '동구', '서구', '남구', '북구', '중구');
    protected static $streetName = array('압구정로', '도산대로', '학동로', '봉은사로', '테헤란로', '역삼로', '논현로', '언주로', '강남대로', '양재천로', '삼성로', '영동대로', '개포로', '선릉로', '반포대로', '서초중앙로', '서초대로', '잠실로', '석촌호수로', '백제고분로', '가락로', '오금로');
    ...
    protected static $addressFormats = array('{{metropolitanCity}} {{borough}} {{streetName}} {{buildingNumber}}', '{{province}} {{city}} {{streetName}} {{buildingNumber}}');
    /**
     * @example '서울특별시'
     */
