...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetPrefix = array('Str.', 'B-dul.', 'Aleea', 'Splaiul', 'Calea', 'P-ța');
    ...
    protected static $cityFormats = array('{{cityName}}', 'Mun. {{cityName}}');
    protected static $streetNameFormats = array('{{streetPrefix}} {{streetPlainName}}');
    protected static $streetAddressFormats = array('{{streetName}} {{buildingNumber}}', '{{streetName}} {{buildingNumber}}', '{{streetName}} {{buildingNumber}}', '{{streetName}} nr. {{buildingNumber}}, bl. {{block}}, ap. {{apartmentNumber}}', '{{streetName}} nr. {{buildingNumber}}, bl. {{block}}, et. {{floor}}, ap. {{apartmentNumber}}', '{{streetName}} nr. {{buildingNumber}}, bl. {{block}}, sc. {{blockSegment}}, et. {{floor}}, ap. {{apartmentNumber}}');
    protected static $addressFormats = array("{{streetAddress}}, {{city}}, {{county}}, CP {{postcode}}");
