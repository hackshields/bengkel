...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetPrefix = array('вул.', 'пров.', 'пл.', 'просп.');
    ...
    protected static $city = array('Вінниця', 'Луцьк', 'Дніпропетровськ', 'Донецьк', 'Житомир', 'Ужгород', 'Запоріжжя', 'Івано-Франківськ', 'Київ', 'Кіровоград', 'Луганськ', 'Львів', 'Миколаїв', 'Одеса', 'Полтава', 'Рівне', 'Суми', 'Тернопіль', 'Харків', 'Херсон', 'Хмельницьк', 'Черкаси', 'Чернівці', 'Чернігів');
    protected static $street = array('Тараса Шевченка', 'Лесі Українки', 'Леніна', '40 років Перемоги', '50 років Жовтня', 'Михайла Грушевського', 'Гагаріна', 'Космонавта Попова', 'Генерала Жадова', 'Пацаєва', 'Волкова');
    protected static $addressFormats = array("{{postcode}}, {{cityAndRegion}}, {{streetPrefix}} {{streetName}}, {{buildingNumber}}");
    protected static $streetAddressFormats = array("{{streetPrefix}} {{streetName}}, {{buildingNumber}}");
