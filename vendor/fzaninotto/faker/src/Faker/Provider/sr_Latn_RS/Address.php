...
class Address extends \Faker\Provider\Address
{
    ...
    protected static $streetPrefix = array('Bulevar');
    protected static $street = array('Kralja Milana', 'Cara Dušana', 'Nikole Tesle', 'Mihajla Pupina', 'Nikole Pašića');
    protected static $streetNameFormats = array('{{street}}', '{{streetPrefix}} {{street}}');
     ...
     */
    protected static $cityNames = array('Beograd', 'Valjevo', 'Vranje', 'Zaječar', 'Zrenjanin', 'Jagodina', 'Kragujevac', 'Kraljevo', 'Kruševac', 'Leskovac', 'Loznica', 'Niš', 'Novi Pazar', 'Novi Sad', 'Pančevo', 'Požarevac', 'Priština', 'Smederevo', 'Sombor', 'Sremska Mitrovica', 'Subotica', 'Užice', 'Čačak', 'Šabac');
    /**
