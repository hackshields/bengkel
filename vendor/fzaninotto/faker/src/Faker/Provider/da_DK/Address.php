...
class Address extends \Faker\Provider\Address
{
     ...
     */
    protected static $citySuffix = array('sted', 'bjerg', 'borg', 'rød', 'lund', 'by');
    /**
     * @var array Danish street suffixes.
     */
    protected static $streetSuffix = array('vej', 'gade', 'skov', 'shaven');
    /**
     * @var array Danish street word suffixes.
     */
    protected static $streetSuffixWord = array('Vej', 'Gade', 'Allé', 'Boulevard', 'Plads', 'Have');
    /**
     ...
     */
    protected static $buildingLevel = array('st.', '%.', '%. sal.');
    /**
     * @var array Danish building sides.
     */
    protected static $buildingSide = array('tv.', 'th.');
    /**
     ...
     */
    protected static $streetNameFormats = array('{{lastName}}{{streetSuffix}}', '{{middleName}}{{streetSuffix}}', '{{lastName}} {{streetSuffixWord}}', '{{middleName}} {{streetSuffixWord}}');
    /**
     * @var array Danish street's address formats.
     */
    protected static $streetAddressFormats = array('{{streetName}} {{buildingNumber}}', '{{streetName}} {{buildingNumber}}, {{buildingLevel}}', '{{streetName}} {{buildingNumber}}, {{buildingLevel}} {{buildingSide}}');
    /**
