...
$this->baseScript = 1;
// =Latin; to set another base script see constants in classes/ucdn.php
...
$this->use_kwt = false;
// "Keep-with-table" Attempts to keep a <h1> to <h6> tagged heading together
...
$this->decimal_align = array('DP' => '.', 'DC' => ',', 'DM' => "·", 'DA' => "٫", 'DD' => '-');
// IMAGES
...
// Use the fixed factor ($this->normalLineheight) when line-height:normal
// Compatible with mPDF versions < 6
$this->useFixedTextBaseline = false;
// Use a fixed ratio ($this->baselineC) to set the text baseline
// Compatible with mPDF versions < 6
...
$this->defaultCSS = array('BODY' => array(
    'FONT-FAMILY' => 'serif',
    'FONT-SIZE' => '11pt',
    'TEXT-INDENT' => '0pt',
    'LINE-HEIGHT' => 'normal',
    ...
    /* mPDF 6 */
    'MARGIN-BOTTOM' => '0.83em',
), 'DL' => array('MARGIN' => '1.67em 0'), 'DT' => array(), 'DD' => array('PADDING-LEFT' => '40px'), 'TABLE' => array(
    'MARGIN' => '0',
