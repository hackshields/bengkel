    ...
    function OpenTag($tag, $attr, &$ahtml, &$ihtml)
    {
        ...
        switch ($tag) {
            case 'DOTTAB':
                ...
                $e = "»¤¬type=dottab,objattr=" . serialize($objattr) . "»¤¬";
                /* -- TABLES -- */
            ...
            case 'SETHTMLPAGEFOOTER':
                ...
                if (isset($attr['NAME']) && $attr['NAME']) {
                    ...
                    if ($tag == 'SETPAGEHEADER' || $tag == 'SETPAGEFOOTER') {
                        $pname = '_nonhtmldefault';
                    } else {
                        $pname = '_default';
                    }
                ...
                if (isset($attr['PAGE']) && $attr['PAGE']) {
                    ...
                    if (strtoupper($attr['PAGE']) == 'O' || strtoupper($attr['PAGE']) == 'ODD') {
                        ...
                        if (strtoupper($attr['PAGE']) == 'E' || strtoupper($attr['PAGE']) == 'EVEN') {
                            $side = 'even';
                        } else {
                            if (strtoupper($attr['PAGE']) == 'ALL') {
                                $side = 'both';
                            } else {
                                $side = 'odd';
                            }
                ...
                if (isset($attr['VALUE']) && $attr['VALUE']) {
                    ...
                    if ($attr['VALUE'] == '1' || strtoupper($attr['VALUE']) == 'ON') {
                        ...
                        if ($attr['VALUE'] == '-1' || strtoupper($attr['VALUE']) == 'OFF') {
                            $set = 0;
                        } else {
                            $set = 1;
                        }
                ...
                if ($side == 'odd' || $side == 'both') {
                    if ($set && ($tag == 'SETHTMLPAGEHEADER' || $tag == 'SETPAGEHEADER')) {
                        ...
                        if ($set && ($tag == 'SETHTMLPAGEFOOTER' || $tag == 'SETPAGEFOOTER')) {
                            $this->mpdf->SetHTMLFooter($this->mpdf->pageHTMLfooters[$pname], 'O');
                        } else {
                            if ($tag == 'SETHTMLPAGEHEADER' || $tag == 'SETPAGEHEADER') {
            ...
            case 'TOC':
                ...
                break;
            case 'TOCPAGEBREAK':
                // custom-tag - set Marker for insertion later of ToC AND adds PAGEBREAK
                if (!class_exists('tocontents', false)) {
                    include _MPDF_PATH . 'classes/tocontents.php';
                }
                if (empty($this->mpdf->tocontents)) {
            ...
            case 'FORMFEED':
                ...
                if (isset($attr['ODD-HEADER-VALUE']) && ($attr['ODD-HEADER-VALUE'] == '1' || strtoupper($attr['ODD-HEADER-VALUE']) == 'ON')) {
                    ...
                    if (isset($attr['ODD-HEADER-VALUE']) && ($attr['ODD-HEADER-VALUE'] == '-1' || strtoupper($attr['ODD-HEADER-VALUE']) == 'OFF')) {
                        $ohvalue = -1;
                    }
                }
                if (isset($attr['EVEN-HEADER-VALUE']) && ($attr['EVEN-HEADER-VALUE'] == '1' || strtoupper($attr['EVEN-HEADER-VALUE']) == 'ON')) {
                    ...
                    if (isset($attr['EVEN-HEADER-VALUE']) && ($attr['EVEN-HEADER-VALUE'] == '-1' || strtoupper($attr['EVEN-HEADER-VALUE']) == 'OFF')) {
                        $ehvalue = -1;
                    }
                }
                if (isset($attr['ODD-FOOTER-VALUE']) && ($attr['ODD-FOOTER-VALUE'] == '1' || strtoupper($attr['ODD-FOOTER-VALUE']) == 'ON')) {
                    ...
                    if (isset($attr['ODD-FOOTER-VALUE']) && ($attr['ODD-FOOTER-VALUE'] == '-1' || strtoupper($attr['ODD-FOOTER-VALUE']) == 'OFF')) {
                        $ofvalue = -1;
                    }
                }
                if (isset($attr['EVEN-FOOTER-VALUE']) && ($attr['EVEN-FOOTER-VALUE'] == '1' || strtoupper($attr['EVEN-FOOTER-VALUE']) == 'ON')) {
                    ...
                    if (isset($attr['EVEN-FOOTER-VALUE']) && ($attr['EVEN-FOOTER-VALUE'] == '-1' || strtoupper($attr['EVEN-FOOTER-VALUE']) == 'OFF')) {
                        $efvalue = -1;
                    }
                }
                if (isset($attr['ORIENTATION']) && (strtoupper($attr['ORIENTATION']) == 'L' || strtoupper($attr['ORIENTATION']) == 'LANDSCAPE')) {
                    ...
                    if (isset($attr['ORIENTATION']) && (strtoupper($attr['ORIENTATION']) == 'P' || strtoupper($attr['ORIENTATION']) == 'PORTRAIT')) {
                        $orient = 'P';
                    } else {
                ...
                if ($tag == 'TOCPAGEBREAK') {
                    ...
                    if ($this->mpdf->ColActive) {
                        ...
                        if ($mgr !== '' || $mgl !== '' || $mgt !== '' || $mgb !== '' || $mgh !== '' || $mgf !== '' || $ohname !== '' || $ehname !== '' || $ofname !== '' || $efname !== '' || $ohvalue || $ehvalue || $ofvalue || $efvalue || $orient != $this->mpdf->CurOrientation || $newformat || $pagesel) {
                            $pagebreaktype = 'cloneall';
                        }
                    }
                }
            ...
            case 'ANNOTATION':
                ...
                $e = "»¤¬type=annot,objattr=" . serialize($objattr) . "»¤¬";
                if ($this->mpdf->tableLevel) {
                    $this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['textbuffer'][] = array($e);
                } else {
                    // *TABLES*
            ...
            case 'TTA':
                ...
                if (in_array($this->mpdf->FontFamily, $this->mpdf->mono_fonts)) {
                    ...
                    if (in_array($this->mpdf->FontFamily, $this->mpdf->serif_fonts)) {
            ...
            case 'SPAN':
                ...
                if ($this->mpdf->title2annots && isset($attr['TITLE'])) {
                    ...
                    $objattr['OPACITY'] = $this->mpdf->annotOpacity;
                    $objattr['COLOR'] = $this->mpdf->ConvertColor('yellow');
                    $annot = "»¤¬type=annot,objattr=" . serialize($objattr) . "»¤¬";
                }
                /* -- END ANNOTATIONS -- */
                ...
                if ($tag == 'BDO') {
                    if (isset($attr['DIR']) and strtolower($attr['DIR']) == 'rtl') {
                        ...
                        if (isset($attr['DIR']) and strtolower($attr['DIR']) == 'ltr') {
                            $bdf = 0x202d;
                            $popd = 'LROPDF';
                        }
                    }
                    ...
                    if ($tag == 'BDI') {
                        ...
                        if (isset($properties['UNICODE-BIDI']) && strtolower($properties['UNICODE-BIDI']) == 'bidi-override') {
                            if ($currdir == 'rtl') {
                                $bdf = 0x202e;
                                $popd = 'RLOPDF';
                            } else {
                            ...
                            if (isset($properties['UNICODE-BIDI']) && strtolower($properties['UNICODE-BIDI']) == 'embed') {
                                if ($currdir == 'rtl') {
                                    $bdf = 0x202b;
                                    $popd = 'RLEPDF';
                                } else {
                                ...
                                if (isset($properties['UNICODE-BIDI']) && strtolower($properties['UNICODE-BIDI']) == 'isolate') {
                                    if ($currdir == 'rtl') {
                                        $bdf = 0x2067;
                                        $popd = 'RLIPDI';
                                    } else {
                                    ...
                                    if (isset($properties['UNICODE-BIDI']) && strtolower($properties['UNICODE-BIDI']) == 'isolate-override') {
                                        if ($currdir == 'rtl') {
                                            $bdf = 0x2067;
                                            $bdf2 = 0x202e;
                                            $popd = 'RLIRLOPDFPDI';
                                        ...
                                        if (isset($properties['UNICODE-BIDI']) && strtolower($properties['UNICODE-BIDI']) == 'plaintext') {
                                            $bdf = 0x2068;
                                            $popd = 'FSIPDI';
                                            // U+2068 FSI
                                        } else {
            ...
            case 'MAIN':
                ...
                if ($tag == 'CAPTION') {
                    ...
                    if (isset($attr['ALIGN']) && strtolower($attr['ALIGN']) == 'bottom') {
                        ...
                        if (isset($p['CAPTION-SIDE']) && strtolower($p['CAPTION-SIDE']) == 'bottom') {
                            $cappos = 'B';
                        } else {
                            $cappos = 'T';
                        }
                ...
                if ($this->mpdf->tableLevel) {
                    ...
                    if ($tag == 'LI') {
                        ...
                        switch ($this->mpdf->listtype[$this->mpdf->listlvl]) {
                            ...
                            default:
                                if ($this->mpdf->listlvl % 3 == 1 && $this->mpdf->_charDefined($this->mpdf->CurrentFont['cw'], 8226)) {
                                    ...
                                    if ($this->mpdf->listlvl % 3 == 2 && $this->mpdf->_charDefined($this->mpdf->CurrentFont['cw'], 9900)) {
                                        $blt = "âš¬";
                                    } else {
                                        if ($this->mpdf->listlvl % 3 == 0 && $this->mpdf->_charDefined($this->mpdf->CurrentFont['cw'], 9642)) {
                                            $blt = "â–ª";
                                        } else {
                                            $blt = '-';
                                        }
                        ...
                        if ($this->mpdf->usingCoreFont) {
                            ...
                            $ls = str_repeat("Â Â ", ($this->mpdf->listlvl - 1) * 2) . $blt . ' ';
                        }
                ...
                if (!$this->mpdf->tableLevel && ($pagesel && (!isset($this->mpdf->page_box['current']) || $pagesel != $this->mpdf->page_box['current']) || isset($p['PAGE-BREAK-BEFORE']) && $p['PAGE-BREAK-BEFORE'])) {
                    ...
                    if (isset($p['PAGE-BREAK-BEFORE'])) {
                        ...
                        if (!isset($this->mpdf->page_box['current']) || $pagesel != $this->mpdf->page_box['current']) {
                            $this->mpdf->AddPage($this->mpdf->CurOrientation, '', '', '', '', '', '', '', '', '', '', '', '', '', '', 0, 0, 0, 0, $pagesel);
                        }
                    }
                    /* -- END CSS-PAGE -- */
                ...
                $currblk['tag'] = $tag;
                $currblk['attr'] = $attr;
                $properties = $this->mpdf->cssmgr->MergeCSS('BLOCK', $tag, $attr);
                ...
                if (isset($properties['FLOAT']) && strtoupper($properties['FLOAT']) == 'RIGHT' && !$this->mpdf->ColActive) {
                    ...
                    if ($setwidth + $currblk['margin_right'] + $bdl + $pdl + $bdr + $pdr > $maxw || $maxw - ($currblk['margin_right'] + $bdl + $pdl + $bdr + $pdr) < 2 * $this->mpdf->GetCharWidth('W', false)) {
                        ...
                        if ($l_max < $r_max && $setwidth + $currblk['margin_right'] + $bdl + $pdl + $bdr + $pdr <= $container_w - $r_width && $container_w - $r_width - ($currblk['margin_right'] + $bdl + $pdl + $bdr + $pdr) > 2 * $this->mpdf->GetCharWidth('W', false)) {
                            ...
                            if ($r_max < $l_max && $setwidth + $currblk['margin_right'] + $bdl + $pdl + $bdr + $pdr <= $container_w - $l_width && $container_w - $l_width - ($currblk['margin_right'] + $bdl + $pdl + $bdr + $pdr) > 2 * $this->mpdf->GetCharWidth('W', false)) {
                    ...
                    if (isset($properties['FLOAT']) && strtoupper($properties['FLOAT']) == 'LEFT' && !$this->mpdf->ColActive) {
                        // Cancel Keep-Block-together
                        $currblk['keep_block_together'] = false;
                        $this->mpdf->kt_y00 = '';
                        $this->mpdf->keep_block_together = 0;
                        ...
                        if ($setwidth + $currblk['margin_left'] + $currblk['margin_right'] + $bdl + $pdl + $bdr + $pdr > $maxw || $maxw - ($currblk['margin_right'] + $currblk['margin_left'] + $bdl + $pdl + $bdr + $pdr) < 2 * $this->mpdf->GetCharWidth('W', false)) {
                            ...
                            if ($l_max < $r_max && $setwidth + $currblk['margin_left'] + $currblk['margin_right'] + $bdl + $pdl + $bdr + $pdr <= $container_w - $r_width && $container_w - $r_width - ($currblk['margin_right'] + $currblk['margin_left'] + $bdl + $pdl + $bdr + $pdr) > 2 * $this->mpdf->GetCharWidth('W', false)) {
                                ...
                                if ($r_max < $l_max && $setwidth + $currblk['margin_left'] + $currblk['margin_right'] + $bdl + $pdl + $bdr + $pdr <= $container_w - $l_width && $container_w - $l_width - ($currblk['margin_right'] + $currblk['margin_left'] + $bdl + $pdl + $bdr + $pdr) > 2 * $this->mpdf->GetCharWidth('W', false)) {
                                    $this->mpdf->ClearFloats('RIGHT', $this->mpdf->blklvl - 1);
                                } else {
                                    $this->mpdf->ClearFloats('BOTH', $this->mpdf->blklvl - 1);
                                }
                ...
                if ($tag == 'OL' || $tag == 'UL') {
                    ...
                    if (strtolower($this->mpdf->list_auto_mode) == 'mpdf' && isset($currblk['list_style_position']) && $currblk['list_style_position'] == 'outside' && isset($currblk['list_style_image']) && $currblk['list_style_image'] == 'none' && (!isset($currblk['list_style_type']) || !preg_match('/U\\+([a-fA-F0-9]+)/i', $currblk['list_style_type']))) {
                        ...
                        if (isset($properties['PADDING-RIGHT']) && $properties['PADDING-RIGHT'] == 'auto' && isset($currblk['direction']) && $currblk['direction'] == 'rtl') {
                            ...
                            if (isset($properties['PADDING-LEFT']) && $properties['PADDING-LEFT'] == 'auto') {
                ...
                if (isset($attr['CODE']) && $attr['CODE']) {
                    ...
                    if ($objattr['btype'] == 'EAN13' || $objattr['btype'] == 'ISBN' || $objattr['btype'] == 'ISSN' || $objattr['btype'] == 'UPCA' || $objattr['btype'] == 'UPCE' || $objattr['btype'] == 'EAN8') {
                        ...
                        if ($objattr['btype'] == 'QR') {
                            ...
                            if ($objattr['btype'] == 'IMB' || $objattr['btype'] == 'RM4SCC' || $objattr['btype'] == 'KIX' || $objattr['btype'] == 'POSTNET' || $objattr['btype'] == 'PLANET') {
                                ...
                                if (in_array($objattr['btype'], array('C128A', 'C128B', 'C128C', 'EAN128A', 'EAN128B', 'EAN128C', 'C39', 'C39+', 'C39E', 'C39E+', 'S25', 'S25+', 'I25', 'I25+', 'I25B', 'I25B+', 'C93', 'MSI', 'MSI+', 'CODABAR', 'CODE11'))) {
                    ...
                    /* -- END CSS-IMAGE-FLOAT -- */
                    $e = "»¤¬type=barcode,objattr=" . serialize($objattr) . "»¤¬";
                    // Clear properties - tidy up
                    $properties = array();
                    /* -- TABLES -- */
                    // Output it to buffers
                            ...
                            if ($w == 0 and $h == 0) {
                                ...
                                if (isset($properties['IMAGE-RESOLUTION'])) {
                                    if (preg_match('/from-image/i', $properties['IMAGE-RESOLUTION']) && isset($info['set-dpi']) && $info['set-dpi'] > 0) {
                                        ...
                                        if (preg_match('/(\\d+)dpi/i', $properties['IMAGE-RESOLUTION'], $m)) {
                                            $dpi = $m[1];
                                            if ($dpi > 0) {
                ...
                if (isset($attr['SRC'])) {
                    ...
                    if (isset($properties['IMAGE-RENDERING']) && $properties['IMAGE-RENDERING']) {
                        if (strtolower($properties['IMAGE-RENDERING']) == 'crisp-edges') {
                            ...
                            if (strtolower($properties['IMAGE-RENDERING']) == 'optimizequality') {
                                $interpolation = true;
                            } else {
                                if (strtolower($properties['IMAGE-RENDERING']) == 'smooth') {
                                    $interpolation = true;
                                } else {
                                    if (strtolower($properties['IMAGE-RENDERING']) == 'auto') {
                    ...
                    // Image file
                    $info = $this->mpdf->_getImage($srcpath, true, true, $orig_srcpath, $interpolation);
                    // mPDF 6
                    if (!$info) {
                        $info = $this->mpdf->_getImage($this->mpdf->noImageFile);
                        if ($info) {
                    ...
                    if (isset($attr['ROTATE'])) {
                        ...
                        if (isset($properties['IMAGE-ORIENTATION'])) {
            ...
            case 'TABLE':
                ...
                if (count($this->mpdf->textbuffer) == 0 && $this->mpdf->lastblocklevelchange == 1 && !$this->mpdf->tableLevel && !$this->mpdf->kwt) {
                    ...
                    $this->mpdf->finishFlowingBlock(true);
                    // true = END of flowing block
                } else {
                    if (!$this->mpdf->tableLevel && count($this->mpdf->textbuffer)) {
                        $this->mpdf->printbuffer($this->mpdf->textbuffer, $blockstate);
                    }
                }
                $this->mpdf->textbuffer = array();
                ...
                if (isset($properties['LINE-STACKING-STRATEGY']) && $properties['LINE-STACKING-STRATEGY']) {
                    ...
                    if ($this->mpdf->tableLevel == 1 && isset($this->mpdf->blk[$this->mpdf->blklvl]['line_stacking_strategy'])) {
                ...
                if (isset($properties['LINE-STACKING-SHIFT']) && $properties['LINE-STACKING-SHIFT']) {
                    ...
                    if ($this->mpdf->tableLevel == 1 && isset($this->mpdf->blk[$this->mpdf->blklvl]['line_stacking_shift'])) {
            ...
            case 'TD':
                ...
                $table =& $this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]];
                $c = array('a' => false, 'R' => false, 'nowrap' => false, 'bgcolor' => false, 'padding' => array('L' => false, 'R' => false, 'T' => false, 'B' => false));
    ...
    function CloseTag($tag, &$ahtml, &$ihtml)
    {
        ...
        if ($tag == 'FONT' || $tag == 'SPAN' || $tag == 'CODE' || $tag == 'KBD' || $tag == 'SAMP' || $tag == 'TT' || $tag == 'VAR' || $tag == 'INS' || $tag == 'STRONG' || $tag == 'CITE' || $tag == 'SUB' || $tag == 'SUP' || $tag == 'S' || $tag == 'STRIKE' || $tag == 'DEL' || $tag == 'Q' || $tag == 'EM' || $tag == 'B' || $tag == 'I' || $tag == 'U' | $tag == 'SMALL' || $tag == 'BIG' || $tag == 'ACRONYM' || $tag == 'MARK' || $tag == 'TIME' || $tag == 'PROGRESS' || $tag == 'METER' || $tag == 'BDO' || $tag == 'BDI') {
            ...
            if ($annot) {
                ...
                if ($this->mpdf->tableLevel) {
                    // *TABLES*
                    $this->mpdf->cell[$this->mpdf->row][$this->mpdf->col]['textbuffer'][] = array($annot);
                    // *TABLES*
                } else {
                    // *TABLES*
        ...
        if ($tag == 'P' || $tag == 'DIV' || $tag == 'H1' || $tag == 'H2' || $tag == 'H3' || $tag == 'H4' || $tag == 'H5' || $tag == 'H6' || $tag == 'PRE' || $tag == 'FORM' || $tag == 'ADDRESS' || $tag == 'BLOCKQUOTE' || $tag == 'CENTER' || $tag == 'DT' || $tag == 'DD' || $tag == 'DL' || $tag == 'CAPTION' || $tag == 'FIELDSET' || $tag == 'UL' || $tag == 'OL' || $tag == 'LI' || $tag == 'ARTICLE' || $tag == 'ASIDE' || $tag == 'FIGURE' || $tag == 'FIGCAPTION' || $tag == 'FOOTER' || $tag == 'HEADER' || $tag == 'HGROUP' || $tag == 'MAIN' || $tag == 'NAV' || $tag == 'SECTION' || $tag == 'DETAILS' || $tag == 'SUMMARY') {
                ...
                if (isset($this->mpdf->h2toc[$tag]) || isset($this->mpdf->h2bookmarks[$tag])) {
                    ...
                    if (count($this->mpdf->textbuffer) == 1) {
                        ...
                        for ($i = 0; $i < count($this->mpdf->textbuffer); $i++) {
                            if (substr($this->mpdf->textbuffer[$i][0], 0, 3) != "»¤¬") {
                                //inline object
            ...
            if (count($this->mpdf->textbuffer) && $this->mpdf->textbuffer[count($this->mpdf->textbuffer) - 1]) {
                if (substr($this->mpdf->textbuffer[count($this->mpdf->textbuffer) - 1][0], 0, 3) != "»¤¬") {
                    // not special content
            ...
            if ($this->mpdf->blk[$this->mpdf->blklvl]['float'] == 'R') {
                ...
                $this->mpdf->floatDivs[] = array('side' => 'R', 'startpage' => $this->mpdf->blk[$this->mpdf->blklvl]['startpage'], 'y0' => $this->mpdf->blk[$this->mpdf->blklvl]['float_start_y'], 'startpos' => $this->mpdf->blk[$this->mpdf->blklvl]['startpage'] * 1000 + $this->mpdf->blk[$this->mpdf->blklvl]['float_start_y'], 'endpage' => $this->mpdf->page, 'y1' => $this->mpdf->y, 'endpos' => $this->mpdf->page * 1000 + $this->mpdf->y, 'w' => $this->mpdf->blk[$this->mpdf->blklvl]['float_width'], 'blklvl' => $this->mpdf->blklvl, 'blockContext' => $this->mpdf->blk[$this->mpdf->blklvl - 1]['blockContext']);
            ...
            if ($this->mpdf->blk[$this->mpdf->blklvl]['float'] == 'L') {
                ...
                $this->mpdf->floatDivs[] = array('side' => 'L', 'startpage' => $this->mpdf->blk[$this->mpdf->blklvl]['startpage'], 'y0' => $this->mpdf->blk[$this->mpdf->blklvl]['float_start_y'], 'startpos' => $this->mpdf->blk[$this->mpdf->blklvl]['startpage'] * 1000 + $this->mpdf->blk[$this->mpdf->blklvl]['float_start_y'], 'endpage' => $this->mpdf->page, 'y1' => $this->mpdf->y, 'endpos' => $this->mpdf->page * 1000 + $this->mpdf->y, 'w' => $this->mpdf->blk[$this->mpdf->blklvl]['float_width'], 'blklvl' => $this->mpdf->blklvl, 'blockContext' => $this->mpdf->blk[$this->mpdf->blklvl - 1]['blockContext']);
                $this->mpdf->y = $this->mpdf->blk[$this->mpdf->blklvl]['float_start_y'];
                $this->mpdf->page = $this->mpdf->blk[$this->mpdf->blklvl]['startpage'];
                $this->mpdf->ResetMargins();
                $this->mpdf->pageoutput[$this->mpdf->page] = array();
        ...
        if ($tag == 'TABLE') {
            ...
            for ($k = 0; $k < $this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['nr']; $k++) {
                for ($l = 0; $l < $this->mpdf->table[$this->mpdf->tableLevel][$this->mpdf->tbctr[$this->mpdf->tableLevel]]['nc']; $l++) {
                    if (!isset($this->mpdf->cell[$k][$l])) {
                        ...
                        $this->mpdf->cell[$k][$l] = array('a' => 'C', 'va' => 'M', 'R' => false, 'nowrap' => false, 'bgcolor' => false, 'padding' => array('L' => false, 'R' => false, 'T' => false, 'B' => false), 'gradient' => false, 's' => 0, 'maxs' => 0, 'textbuffer' => array(), 'dfs' => $this->mpdf->FontSize);
                        if (!$this->mpdf->simpleTables) {
            ...
            if ($this->mpdf->tableLevel > 1) {
                ...
                $e = "»¤¬type=nestedtable,objattr=" . serialize($objattr) . "»¤¬";
                $this->mpdf->_saveCellTextBuffer($e);
            ...
            if (isset($this->mpdf->table[1][1]['overflow']) && $this->mpdf->table[1][1]['overflow'] == 'visible') {
                ...
                if ($reset_to_minimum_width) {
                    ...
                    $this->mpdf->_tableColumnWidth($this->mpdf->table[1][1], false);
                    // repeat
            ...
            for ($lvl = 2; $lvl <= $this->mpdf->innermostTableLevel; $lvl++) {
                for ($nid = 1; $nid <= $this->mpdf->tbctr[$lvl]; $nid++) {
                    ...
                    if (isset($this->mpdf->table[$lvl][$nid]['wpercent']) && $this->mpdf->table[$lvl][$nid]['wpercent'] && $lvl > 1) {
                        ...
                        if ($parentwidth > $this->mpdf->table[$lvl][$nid]['maw']) {
            ...
            if ($this->mpdf->table[1][1]['overflow'] == 'visible') {
                ...
                if ($maxrowheight > $fullpage) {
                    ...
                    if ($this->mpdf->table_rotate) {
                        ...
                        if ($this->mpdf->table_keep_together || $this->mpdf->table[1][1]['nr'] == 1 && !$this->mpdf->writingHTMLfooter) {
                            if ($tableheight > $fullpage) {
                                if ($this->mpdf->shrin_k * $this->mpdf->tbsqrt($tableheight / $fullpage, 1) <= $this->mpdf->shrink_this_table_to_fit) {
                                    ...
                                    if ($this->mpdf->tableMinSizePriority) {
                                        $this->mpdf->table_keep_together = false;
                                        $recalculate = 1.001;
                                    } else {
                                        if ($this->mpdf->y != $this->mpdf->tMargin) {
                                    ...
                                    if ($this->mpdf->shrin_k * $this->mpdf->tbsqrt($tableheight / $remainingpage, 1) <= $this->mpdf->shrink_this_table_to_fit) {
                                        ...
                                        if ($this->mpdf->y != $this->mpdf->tMargin) {
                                            ...
                                            if ($this->mpdf->AcceptPageBreak()) {
                                                ...
                                                if ($this->mpdf->ColActive && $tableheight > $this->mpdf->h - $this->mpdf->bMargin - $this->mpdf->y0) {
                                                    $this->mpdf->AddPage($this->mpdf->CurOrientation);
                                                }
                                            }
                                            $this->mpdf->kwt_moved = true;
                ...
                while ($recalculate != 1) {
                    ...
                    if ($maxrowheight > $fullpage) {
                        ...
                        if ($this->mpdf->table_rotate && $tableheight > $remainingpage && !$added_page) {
