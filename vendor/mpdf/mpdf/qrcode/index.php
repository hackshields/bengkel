...
<html>
	<head>
		<title>Spipu Qrcode <?php 
echo __CLASS_QRCODE__;
?></title>
		<meta name="Title"			content="Spipu - Qrcode <?php 
echo __CLASS_QRCODE__;
?>" > 
		<meta name="Description"	content="Spipu - Qrcode <?php 
echo __CLASS_QRCODE__;
?>" >
	...
	<body>
		<center>
			<form method="GET" action="">
				<textarea name="msg" cols="40" rows="7"><?php 
