...
class BatchController extends Controller
{
    ...
    {
        return array_merge(parent::options($id), ['template', 'overwrite', 'extendedModels', 'enableI18N', 'singularEntities', 'messageCategory', 'tables', 'tablePrefix', 'modelDb', 'modelNamespace', 'modelBaseClass', 'modelBaseTraits', 'modelBaseClassSuffix', 'crudControllerNamespace', 'crudSearchModelNamespace', 'crudSearchModelSuffix', 'crudViewPath', 'crudPathPrefix', 'crudProviders', 'crudSkipRelations', 'crudBaseControllerClass', 'modelGenerateQuery', 'modelQueryNamespace', 'modelQueryBaseClass']);
    }
    /**
    ...
    public function actionModels()
    {
        ...
        foreach ($this->tables as $table) {
            ...
            $params = [
                ...
                // TODO: setting is not recognized in giiant
    ...
    protected function getYiiConfiguration()
    {
        if (isset($GLOBALS['config'])) {
            ...
            $config = \yii\helpers\ArrayHelper::merge(require \Yii::getAlias('@app') . '/../common/config/main.php', is_file(\Yii::getAlias('@app') . '/../common/config/main-local.php') ? require \Yii::getAlias('@app') . '/../common/config/main-local.php' : [], require \Yii::getAlias('@app') . '/../console/config/main.php', is_file(\Yii::getAlias('@app') . '/../console/config/main-local.php') ? require \Yii::getAlias('@app') . '/../console/config/main-local.php' : []);
        }
        return $config;
    }
}
