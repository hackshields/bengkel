...
class Generator extends \yii\gii\generators\crud\Generator
{
    ...
    {
        $files = FileHelper::findFiles(__DIR__ . DIRECTORY_SEPARATOR . 'providers', ['only' => ['*.php'], 'recursive' => false]);
    ...
    {
        return array_merge(parent::rules(), [[['providerList', 'actionButtonClass', 'viewPath', 'pathPrefix'], 'safe'], [['viewPath'], 'required']]);
    }
    /**
     * @inheritdoc
     */
