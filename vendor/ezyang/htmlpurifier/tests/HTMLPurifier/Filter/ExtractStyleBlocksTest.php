...
class HTMLPurifier_Filter_ExtractStyleBlocksTest extends HTMLPurifier_Harness
{
    ...
    public function test_tokenizeHTML_extractStyleBlocks()
    {
        ...
        $this->assertIdentical($purifier->context->get('StyleBlocks'), array(".foo {\ntext-align:center;\n}", "* {\nfont-size:12pt;\n}"));
    }
    ...
    {
        $this->assertExtractStyleBlocks("<style>1</style><style>2</style>NOP<style>4</style>", "NOP", array('1', '2', '4'));
    }
    public function test_extractStyleBlocks_blockWithAttributes()
    {
        $this->assertExtractStyleBlocks('<style type="text/css">css</style>', '', array('css'));
    }
    public function test_extractStyleBlocks_styleWithPadding()
    {
        $this->assertExtractStyleBlocks("Alas<styled>Awesome</styled>\n<style>foo</style> Trendy!", "Alas<styled>Awesome</styled>\n Trendy!", array('foo'));
    }
    ...
    {
        $this->assertCleanCSS("&, & {\ntext-align: center;\n}", "");
        $this->assertCleanCSS("&, b {\ntext-align:center;\n}", "b {\ntext-align:center;\n}");
        $this->assertCleanCSS("& a #foo:hover.bar   +b > i {\ntext-align:center;\n}", "a #foo:hover.bar + b \\3E  i {\ntext-align:center;\n}");
