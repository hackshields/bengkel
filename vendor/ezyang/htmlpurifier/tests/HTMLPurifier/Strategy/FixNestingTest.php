...
class HTMLPurifier_Strategy_FixNestingTest extends HTMLPurifier_StrategyHarness
{
    ...
    {
        $this->assertResult('<b><div>Illegal div.</div></b>', '<b>Illegal div.</b>');
    }
    ...
    {
        $this->assertResult('<ul>Illegal text<li>Legal item</li></ul>', '<ul><li>Illegal text</li><li>Legal item</li></ul>');
    }
    public function testRemoveIllegalPCDATA()
    {
        $this->assertResult('<table><tr>Illegal text<td></td></tr></table>', '<table><tr><td></td></tr></table>');
    }
    ...
    {
        $this->assertResult('<span><ins><div>Not allowed!</div></ins></span>', '<span><ins>Not allowed!</ins></span>');
    }
    public function testChameleonRemoveBlockInBlockNodeWithInlineContent()
    {
        $this->assertResult('<h1><ins><div>Not allowed!</div></ins></h1>', '<h1><ins>Not allowed!</ins></h1>');
    }
    public function testNestedChameleonRemoveBlockInNodeWithInlineContent()
    {
        $this->assertResult('<h1><ins><del><div>Not allowed!</div></del></ins></h1>', '<h1><ins><del>Not allowed!</del></ins></h1>');
    }
    public function testNestedChameleonPreserveBlockInBlock()
    {
        $this->assertResult('<div><ins><del><div>Allowed!</div></del></ins></div>');
    }
    public function testExclusionsIntegration()
    {
        // test exclusions
        $this->assertResult('<a><span><a>Not allowed</a></span></a>', '<a><span></span></a>');
    }
