...
class HTMLPurifier_Strategy_MakeWellFormed_EndRewindInjectorTest extends HTMLPurifier_StrategyHarness
{
    public function setUp()
    {
        ...
        $this->config->set('AutoFormat.Custom', array(new HTMLPurifier_Strategy_MakeWellFormed_EndRewindInjector()));
    }
    ...
    {
        $this->config->set('AutoFormat.Custom', array(new HTMLPurifier_Strategy_MakeWellFormed_EndRewindInjector(), new HTMLPurifier_Strategy_MakeWellFormed_EndRewindInjector()));
