...
class HTMLPurifier_URITest extends HTMLPurifier_URIHarness
{
    ...
    {
        $this->assertToString('http://bob@example.com:300/foo?bar=baz#fragment', 'http', 'bob', 'example.com', 300, '/foo', 'bar=baz', 'fragment');
    }
    public function test_toString_scheme()
    {
        $this->assertToString('http:', 'http', null, null, null, '', null, null);
    }
    public function test_toString_authority()
    {
        $this->assertToString('//bob@example.com:8080', null, 'bob', 'example.com', 8080, '', null, null);
    }
    public function test_toString_path()
    {
        $this->assertToString('/path/to', null, null, null, null, '/path/to', null, null);
    }
    public function test_toString_query()
    {
        $this->assertToString('?q=string', null, null, null, null, '', 'q=string', null);
    }
    public function test_toString_fragment()
    {
        $this->assertToString('#fragment', null, null, null, null, '', null, 'fragment');
    }
    ...
    {
        $this->assertValidation("http://user㑔:@foo.com", 'http://user%E3%91%94:@foo.com');
    }
    public function test_validate_path_abempty()
    {
        $this->assertValidation("http://host/㑔:", 'http://host/%E3%91%94:');
    }
    public function test_validate_path_absolute()
    {
        $this->assertValidation("/㑔:", '/%E3%91%94:');
    }
    public function test_validate_path_rootless()
    {
        $this->assertValidation("mailto:㑔:", 'mailto:%E3%91%94:');
    }
