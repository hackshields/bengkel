...
class HTMLPurifier_HTMLDefinitionTest extends HTMLPurifier_Harness
{
    ...
    public function test_parseTinyMCEAllowedList()
    {
        ...
        $this->assertEqual(
            // alternate form:
            $def->parseTinyMCEAllowedList('span[style]
strong
a[href|title]
'),
    ...
    {
        $this->assertPurification('<p style="font-weight:bold;" class="foo">Jelly</p><br style="clear:both;" />', '<p style="font-weight:bold;">Jelly</p><br style="clear:both;" />');
    }
    ...
    {
        $this->assertPurification('<p style="font-weight:bold;" class="foo">Jelly</p><br style="clear:both;" />', '<p style="font-weight:bold;">Jelly</p><br />');
    }
    ...
    public function test_AllowedAttributes_multiple()
    {
        ...
        $this->assertPurification('<p style="font-weight:bold;" class="foo" title="foo">Jelly</p><br style="clear:both;" class="foo" title="foo" />', '<p style="font-weight:bold;" title="foo">Jelly</p><br class="foo" title="foo" />');
    }
    ...
    {
        $this->assertPurification('<b style="float:left;">b</b><i style="float:left;">i</i>', '<b>b</b><i style="float:left;">i</i>');
    }
    ...
    {
        $this->assertPurification('<b class="foo" style="float:left;">b</b><i style="float:left;">i</i>', '<b class="foo">b</b><i>i</i>');
    }
    ...
    public function test_injector()
    {
        ...
        $this->assertIdentical($this->config->getHTMLDefinition()->info_injector, array('MyInjector' => $injector));
    }
    ...
    public function test_injectorIntegration()
    {
        ...
        $this->assertIdentical($this->config->getHTMLDefinition()->info_injector, array('Linkify' => new HTMLPurifier_Injector_Linkify()));
    }
