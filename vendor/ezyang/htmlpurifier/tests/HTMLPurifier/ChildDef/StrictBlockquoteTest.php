...
class HTMLPurifier_ChildDef_StrictBlockquoteTest extends HTMLPurifier_ChildDefHarness
{
    ...
    {
        $this->assertResult('Wrap' . '<p>Do not wrap</p>', '<p>Wrap</p><p>Do not wrap</p>');
    }
    public function testWrapInlineElements()
    {
        $this->assertResult('<p>Do not</p>' . '<b>Wrap</b>', '<p>Do not</p><p><b>Wrap</b></p>');
    }
    public function testWrapAndRemoveInvalidTags()
    {
        $this->assertResult('<li>Not allowed</li>Paragraph.<p>Hmm.</p>', '<p>Not allowedParagraph.</p><p>Hmm.</p>');
    }
    public function testWrapComplicatedSring()
    {
        $this->assertResult($var = 'He said<br />perhaps<br />we should <b>nuke</b> them.', "<p>{$var}</p>");
    }
    public function testWrapAndRemoveInvalidTagsComplex()
    {
        $this->assertResult('<foo>Bar</foo><bas /><b>People</b>Conniving.' . '<p>Fools!</p>', '<p>Bar' . '<b>People</b>Conniving.</p><p>Fools!</p>');
    }
