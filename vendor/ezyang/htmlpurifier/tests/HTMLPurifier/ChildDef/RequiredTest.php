...
class HTMLPurifier_ChildDef_RequiredTest extends HTMLPurifier_ChildDefHarness
{
    public function testPrepareString()
    {
        ...
        $this->assertIdentical($def->elements, array('foobar' => true, 'bang' => true, 'gizmo' => true));
    }
    public function testPrepareArray()
    {
        $def = new HTMLPurifier_ChildDef_Required(array('href', 'src'));
        $this->assertIdentical($def->elements, array('href' => true, 'src' => true));
    }
    ...
    {
        $this->assertResult('<dt>Term</dt>Text in an illegal location' . '<dd>Definition</dd><b>Illegal tag</b>', '<dt>Term</dt><dd>Definition</dd>');
    ...
    {
        $this->assertResult('<dd>Definition</dd>       <b></b>       ', '<dd>Definition</dd>              ');
    }
