...
class HTMLPurifier_DoctypeRegistryTest extends HTMLPurifier_Harness
{
    public function test_register()
    {
        ...
        $d = $registry->register($name = 'XHTML 1.0 Transitional', $xml = true, $modules = array('module-one', 'module-two'), $tidyModules = array('lenient-module'), $aliases = array('X10T'));
        ...
        // test shorthand
        $d = $registry->register($name = 'XHTML 1.0 Strict', true, 'module', 'Tidy', 'X10S');
