...
class HTMLPurifier_HTMLModule_ScriptingTest extends HTMLPurifier_HTMLModuleHarness
{
    ...
    public function testDefaultRemoval()
    {
        ...
        $this->assertResult('<script type="text/javascript">foo();</script>', '');
    }
    ...
    {
        $this->assertResult('<script type="text/javascript">//<![CDATA[
alert("<This is compatible with XHTML>");
//]]></script>');
    }
    public function testAllAttributes()
    {
        $this->assertResult('<script
                defer="defer"
                src="test.js"
    ...
    public function testUnsupportedAttributes()
    {
        $this->assertResult('<script
                type="text/javascript"
                charset="utf-8"
            >PCDATA</script>', '<script type="text/javascript">PCDATA</script>');
    }
}
// vim: et sw=4 sts=4
