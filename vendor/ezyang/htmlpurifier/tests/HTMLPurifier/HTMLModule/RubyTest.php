...
class HTMLPurifier_HTMLModule_RubyTest extends HTMLPurifier_HTMLModuleHarness
{
    ...
    {
        $this->assertResult('<ruby><rb>WWW</rb><rt>World Wide Web</rt></ruby>');
    }
    public function testRPUse()
    {
        $this->assertResult('<ruby><rb>WWW</rb><rp>(</rp><rt>World Wide Web</rt><rp>)</rp></ruby>');
    }
    public function testComplexUse()
    {
        $this->assertResult('<ruby>
  <rbc>
    <rb>10</rb>
    <rb>31</rb>
    <rb>2002</rb>
