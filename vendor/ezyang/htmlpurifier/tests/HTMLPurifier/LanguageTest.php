...
class HTMLPurifier_LanguageTest extends HTMLPurifier_Harness
{
    ...
    public function test_formatMessage_arrayParameter()
    {
        ...
        $this->assertIdentical($lang->formatMessage('LanguageTest: List', array(1 => $array)), 'Item1, Item2 and Item3');
        $array = array('Key1' => 'Value1', 'Key2' => 'Value2');
        $this->assertIdentical($lang->formatMessage('LanguageTest: Hash', array(1 => $array)), 'Key1 and Key2; Value1 and Value2');
    }
}
// vim: et sw=4 sts=4
