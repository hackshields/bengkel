...
class HTMLPurifier_AttrDef_URI_HostTest extends HTMLPurifier_AttrDefHarness
{
    public function test()
    {
        ...
        // IPv6
        $this->assertDef('124.15.6.89');
        // IPv4
        $this->assertDef('www.google.com');
        // reg-name
        ...
        $this->assertDef('f-.top', false);
        $this->assertDef("中文.com.cn", false);
    }
    public function testIDNA()
    {
        ...
        $this->assertDef("中文.com.cn", "xn--fiq228c.com.cn");
        $this->assertDef(" .com", false);
        // rejected
    }
