...
class HTMLPurifier_AttrDef_URITest extends HTMLPurifier_AttrDefHarness
{
    ...
    {
        $this->assertDef('http://www.example.com/%56%fc%GJ%5%FC', 'http://www.example.com/V%FC%25GJ%255%FC');
    }
    public function testPercentEncoding()
    {
        $this->assertDef('http:colon:mercenary', 'colon%3Amercenary');
    }
    public function testPercentEncodingPreserve()
    {
        $this->assertDef('http://www.example.com/abcABC123-_.!~*()\'');
    }
    ...
    public function testConfigMunge()
    {
        ...
        $this->assertDef('http://www.example.com/', 'http://www.google.com/url?q=http%3A%2F%2Fwww.example.com%2F');
