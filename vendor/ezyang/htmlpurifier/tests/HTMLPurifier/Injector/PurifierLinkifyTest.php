...
class HTMLPurifier_Injector_PurifierLinkifyTest extends HTMLPurifier_InjectorHarness
{
    ...
    {
        $this->assertResult('%Namespace.Directive', '<a href="#Namespace.Directive">%Namespace.Directive</a>');
    }
    public function testLinkifyWithAdjacentTextNodes()
    {
        $this->assertResult('This %Namespace.Directive thing', 'This <a href="#Namespace.Directive">%Namespace.Directive</a> thing');
    }
    public function testLinkifyInBlock()
    {
        $this->assertResult('<div>This %Namespace.Directive thing</div>', '<div>This <a href="#Namespace.Directive">%Namespace.Directive</a> thing</div>');
    }
    public function testPreserveInATag()
    {
        $this->assertResult('<a>%Namespace.Directive</a>');
    }
