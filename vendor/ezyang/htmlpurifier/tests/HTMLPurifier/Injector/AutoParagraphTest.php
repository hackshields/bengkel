...
class HTMLPurifier_Injector_AutoParagraphTest extends HTMLPurifier_InjectorHarness
{
    ...
    {
        $this->assertResult('Foobar', '<p>Foobar</p>');
    }
    public function testSingleMultiLineParagraph()
    {
        $this->assertResult('Par 1
Par 1 still', '<p>Par 1
Par 1 still</p>');
    }
...
<p>Par2</p>');
    ...
    {
        $this->assertResult('<b>Par1</b>

<i>Par2</i>', '<p><b>Par1</b></p>

<p><i>Par2</i></p>');
    }
    public function testSingleParagraphThatLooksLikeTwo()
    {
        $this->assertResult('<b>Par1
...
Par2</b></p>');
    ...
    {
        $this->assertResult('Par1<p>Par2</p>', '<p>Par1</p>

<p>Par2</p>');
    }
    public function testParagraphUnclosedInlineElement()
    {
        $this->assertResult('<b>Par1', '<p><b>Par1</b></p>');
    }
    public function testPreservePreTags()
    {
        $this->assertResult('<pre>Par1
...
<p>Par3</p>');
    ...
    {
        $this->assertResult('Par<b>1</b>', '<p>Par<b>1</b></p>');
    }
...
');
    ...
    {
        $this->assertResult('<div>Par1

Par2</div>', '<div><p>Par1</p>

<p>Par2</p></div>');
    }
    public function testParagraphInlineNodeInsideBlockNode()
    {
        $this->assertResult('<div><b>Par1</b>

Par2</div>', '<div><p><b>Par1</b></p>
...
<i>Par2</i></div>', '<div><p><b>Par1</b></p>

<p><i>Par2</i></p></div>');
    }
    public function testPreserveInlineNodesInPreTag()
    {
        $this->assertResult('<pre><b>Par1</b>

<i>Par2</i></pre>');
    }
    public function testSplitUpInternalsOfPTagInBlockNode()
    {
        $this->assertResult('<div><p>Foo

Bar</p></div>', '<div><p>Foo</p>

<p>Bar</p></div>');
    }
    public function testSplitUpInlineNodesInPTagInBlockNode()
    {
        $this->assertResult('<div><p><b>Foo</b>

<i>Bar</i></p></div>', '<div><p><b>Foo</b></p>
...
<p><i>Bar</i></p></div>');
    ...
    {
        $this->assertResult('<blockquote>Par1

Par2</blockquote>', '<blockquote><p>Par1</p>

<p>Par2</p></blockquote>');
    }
    public function testNoParagraphBetweenListItem()
    {
        $this->assertResult('<ul><li>Foo</li>

<li>Bar</li></ul>');
    }
    public function testParagraphSingleElementWithSurroundingSpace()
    {
        $this->assertResult('<div>
...
Par2');
    ...
    {
        $this->assertResult('<div><code>bar</code> mmm <pre>asdf</pre></div>');
    }
    public function testInlineAndBlockTagInDivNeedingParagraph()
    {
        $this->assertResult('<div><code>bar</code> mmm

<pre>asdf</pre></div>', '<div><p><code>bar</code> mmm</p>

<pre>asdf</pre></div>');
    }
    public function testTextInlineNodeTextThenDoubleNewlineNeedsParagraph()
    {
        $this->assertResult('<div>asdf <code>bar</code> mmm

<pre>asdf</pre></div>', '<div><p>asdf <code>bar</code> mmm</p>

<pre>asdf</pre></div>');
    }
    public function testUpcomingTokenHasNewline()
    {
        $this->assertResult('<div>Test<b>foo</b>bar<b>bing</b>bang

boo</div>', '<div><p>Test<b>foo</b>bar<b>bing</b>bang</p>

<p>boo</p></div>');
    }
    public function testEmptyTokenAtEndOfDiv()
    {
        $this->assertResult('<div><p>foo</p>
</div>', '<div><p>foo</p>
</div>');
    }
    ...
    {
        $this->assertResult("<div><b>B</b><pre>Ba</pre>\n\nBar</div>", "<div><b>B</b><pre>Ba</pre>\n\n<p>Bar</p></div>");
    }
    public function testElementState22()
    {
        $this->assertResult('<ul><li>foo</li></ul>');
    }
    public function testElementState311()
    {
        $this->assertResult('<p>Foo</p><b>Bar</b>', '<p>Foo</p>

<p><b>Bar</b></p>');
    }
    public function testAutoClose()
    {
        $this->assertResult('<p></p>
<hr />');
    }
