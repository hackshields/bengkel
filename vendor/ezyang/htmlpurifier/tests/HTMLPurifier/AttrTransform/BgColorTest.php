...
class HTMLPurifier_AttrTransform_BgColorTest extends HTMLPurifier_AttrTransformHarness
{
    ...
    {
        $this->assertResult(array('bgcolor' => '#000000'), array('style' => 'background-color:#000000;'));
    }
    public function testPrependNewCSS()
    {
        $this->assertResult(array('bgcolor' => '#000000', 'style' => 'font-weight:bold'), array('style' => 'background-color:#000000;font-weight:bold'));
    }
    public function testLenientTreatmentOfInvalidInput()
    {
        ...
        $this->assertResult(array('bgcolor' => '#F00'), array('style' => 'background-color:#F00;'));
    }
}
// vim: et sw=4 sts=4
