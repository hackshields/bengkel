...
class XmlRpc_Freshmeat
{
    ...
    public $chatty = false;
    public $encodeOptions = array('encoding' => 'utf-8');
    /**
     ...
     * syntax.
     */
    public $signatures = array('login' => array('username', 'password'), 'fetch_branch_list' => array('project_name'), 'fetch_release' => array('project_name', 'branch_name', 'version'), 'withdraw_release' => array('project_name', 'branch_name', 'version'));
    protected $sid = null;
    /**
