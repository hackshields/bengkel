...
class DbPanel extends Panel
{
    ...
    public function getDetail()
    {
        ...
        return Yii::$app->view->render('panels/db/detail', ['panel' => $this, 'dataProvider' => $dataProvider, 'searchModel' => $searchModel]);
    }
    /**
        ...
        if ($this->_models === null) {
            ...
            foreach ($timings as $seq => $dbTiming) {
                $this->_models[] = [
                    ...
                    'query' => $dbTiming['info'],
                    'duration' => $dbTiming['duration'] * 1000,
                    // in milliseconds
                    'trace' => $dbTiming['trace'],
                    'timestamp' => $dbTiming['timestamp'] * 1000,
                    // in milliseconds
                    'seq' => $seq,
                ];
            }
    ...
    {
        return array_reduce($this->_models, function ($result, $item) {
