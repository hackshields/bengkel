...
class ProfilingPanel extends Panel
{
    ...
    {
        return Yii::$app->view->render('panels/profile/summary', ['memory' => sprintf('%.1f MB', $this->data['memory'] / 1048576), 'time' => number_format($this->data['time'] * 1000) . ' ms', 'panel' => $this]);
    }
    /**
     * @inheritdoc
     */
    public function getDetail()
    {
        ...
        return Yii::$app->view->render('panels/profile/detail', ['panel' => $this, 'dataProvider' => $dataProvider, 'searchModel' => $searchModel, 'memory' => sprintf('%.1f MB', $this->data['memory'] / 1048576), 'time' => number_format($this->data['time'] * 1000) . ' ms']);
    }
    /**
     * @inheritdoc
     */
    public function save()
    {
        ...
        return ['memory' => memory_get_peak_usage(), 'time' => microtime(true) - YII_BEGIN_TIME, 'messages' => $messages];
    }
    /**
        ...
        if ($this->_models === null) {
            ...
            foreach ($timings as $seq => $profileTiming) {
                $this->_models[] = [
                    ...
                    'timestamp' => $profileTiming['timestamp'] * 1000,
                    //in milliseconds
                    'seq' => $seq,
                ];
            }
