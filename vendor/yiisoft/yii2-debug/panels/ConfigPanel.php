...
class ConfigPanel extends Panel
{
    ...
    {
        return ['phpVersion' => PHP_VERSION, 'yiiVersion' => Yii::getVersion(), 'application' => ['yii' => Yii::getVersion(), 'name' => Yii::$app->name, 'env' => YII_ENV, 'debug' => YII_DEBUG], 'php' => ['version' => PHP_VERSION, 'xdebug' => extension_loaded('xdebug'), 'apc' => extension_loaded('apc'), 'memcache' => extension_loaded('memcache')], 'extensions' => Yii::$app->extensions];
    }
}
