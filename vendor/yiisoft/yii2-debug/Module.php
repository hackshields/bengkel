...
class Module extends \yii\base\Module implements BootstrapInterface
{
    ...
    public function bootstrap($app)
    {
        ...
        $app->getUrlManager()->addRules([$this->id => $this->id, $this->id . '/<controller:[\\w\\-]+>/<action:[\\w\\-]+>' => $this->id . '/<controller>/<action>'], false);
    }
    /**
     * @inheritdoc
     */
    ...
    public function renderToolbar($event)
    {
        ...
        $url = Url::toRoute(['/' . $this->id . '/default/toolbar', 'tag' => $this->logTarget->tag]);
    ...
    {
        return ['config' => ['class' => 'yii\\debug\\panels\\ConfigPanel'], 'request' => ['class' => 'yii\\debug\\panels\\RequestPanel'], 'log' => ['class' => 'yii\\debug\\panels\\LogPanel'], 'profiling' => ['class' => 'yii\\debug\\panels\\ProfilingPanel'], 'db' => ['class' => 'yii\\debug\\panels\\DbPanel'], 'assets' => ['class' => 'yii\\debug\\panels\\AssetPanel'], 'mail' => ['class' => 'yii\\debug\\panels\\MailPanel']];
    }
}
