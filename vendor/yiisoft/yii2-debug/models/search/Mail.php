...
class Mail extends Base
{
    ...
    {
        return [[['from', 'to', 'reply', 'cc', 'bcc', 'subject', 'body', 'charset'], 'safe']];
    }
    /**
     * @inheritdoc
     */
    ...
    {
        return ['from' => 'From', 'to' => 'To', 'reply' => 'Reply', 'cc' => 'Copy receiver', 'bcc' => 'Hidden copy receiver', 'subject' => 'Subject', 'charset' => 'Charset'];
    }
    /**
    ...
    {
        $dataProvider = new ArrayDataProvider(['allModels' => $models, 'pagination' => ['pageSize' => 20], 'sort' => ['attributes' => ['from', 'to', 'reply', 'cc', 'bcc', 'subject', 'body', 'charset']]]);
