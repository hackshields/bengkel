...
class Db extends Base
{
    ...
    {
        $dataProvider = new ArrayDataProvider(['allModels' => $models, 'pagination' => false, 'sort' => ['attributes' => ['duration', 'seq', 'type', 'query'], 'defaultOrder' => ['duration' => SORT_DESC]]]);
