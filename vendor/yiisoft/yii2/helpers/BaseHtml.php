...
class BaseHtml
{
     ...
     */
    public static $attributeOrder = ['type', 'id', 'class', 'name', 'value', 'href', 'src', 'action', 'method', 'selected', 'checked', 'readonly', 'disabled', 'multiple', 'size', 'maxlength', 'width', 'height', 'rows', 'cols', 'alt', 'title', 'rel', 'media'];
    /**
    ...
    public static function checkboxList($name, $selection = null, $items = [], $options = [])
    {
        ...
        foreach ($items as $value => $label) {
            ...
            if ($formatter !== null) {
                ...
                $lines[] = static::checkbox($name, $checked, array_merge($itemOptions, ['value' => $value, 'label' => $encode ? static::encode($label) : $label]));
            }
            $index++;
        }
        if (isset($options['unselect'])) {
    ...
    public static function activeFileInput($model, $attribute, $options = [])
    {
        ...
        return static::activeHiddenInput($model, $attribute, ['id' => null, 'value' => '']) . static::activeInput('file', $model, $attribute, $options);
    }
    /**
