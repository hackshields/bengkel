...
class BooleanValidator extends Validator
{
    ...
    protected function validateValue($value)
    {
        ...
        if (!$valid) {
            return [$this->message, ['true' => $this->trueValue, 'false' => $this->falseValue]];
        } else {
            return null;
        }
    }
    ...
    {
        $options = ['trueValue' => $this->trueValue, 'falseValue' => $this->falseValue, 'message' => Yii::$app->getI18n()->format($this->message, ['attribute' => $model->getAttributeLabel($attribute), 'true' => $this->trueValue, 'false' => $this->falseValue], Yii::$app->language)];
        if ($this->skipOnEmpty) {
