...
class CompareValidator extends Validator
{
    ...
    public function validateAttribute($model, $attribute)
    {
        ...
        if (!$this->compareValues($this->operator, $this->type, $value, $compareValue)) {
            $this->addError($model, $attribute, $this->message, ['compareAttribute' => $compareLabel, 'compareValue' => $compareValue]);
        }
    }
    /**
     * @inheritdoc
    ...
    protected function validateValue($value)
    {
        ...
        if (!$this->compareValues($this->operator, $this->type, $value, $this->compareValue)) {
            return [$this->message, ['compareAttribute' => $this->compareValue, 'compareValue' => $this->compareValue]];
        } else {
            return null;
        }
    }
