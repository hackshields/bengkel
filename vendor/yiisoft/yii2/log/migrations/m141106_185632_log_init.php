...
class m141106_185632_log_init extends Migration
{
    ...
    public function up()
    {
        ...
        foreach ($targets as $target) {
            ...
            $this->createTable($target->logTable, ['id' => Schema::TYPE_BIGPK, 'level' => Schema::TYPE_INTEGER, 'category' => Schema::TYPE_STRING, 'log_time' => Schema::TYPE_DOUBLE, 'prefix' => Schema::TYPE_TEXT, 'message' => Schema::TYPE_TEXT], $tableOptions);
