...
abstract class BaseMigrateController extends Controller
{
     ...
     */
    protected abstract function getMigrationHistory($limit);
    /**
     * Adds new migration entry to the history.
     * @param string $version migration version name.
     */
    protected abstract function addMigrationHistory($version);
    /**
     * Removes existing migration from the history.
     * @param string $version migration version name.
     */
    protected abstract function removeMigrationHistory($version);
}
