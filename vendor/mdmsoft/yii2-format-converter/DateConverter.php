...
class DateConverter extends BaseConverter
{
     ...
     */
    public static $dbDatetimeFormat = ['mysql' => ['date' => 'yyyy-MM-dd', 'time' => 'HH:mm:ss', 'datetime' => 'yyyy-MM-dd HH:mm:ss'], 'pgsql' => ['date' => 'yyyy-MM-dd', 'time' => 'HH:mm:ss', 'datetime' => 'yyyy-MM-dd HH:mm:ss'], 'default' => ['date' => 'yyyy-MM-dd', 'time' => 'HH:mm:ss', 'datetime' => 'yyyy-MM-dd HH:mm:ss']];
    /**
     * @inheritdoc
     */
